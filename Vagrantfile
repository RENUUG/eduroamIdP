#    #This vagrant file has been edited to fit in only the relevant code.
...
#    #Used public network because the best option in this case would be a bridged network on your VirtualBox
...
#   # Display the VirtualBox GUI when booting the machine
    #vb.gui = false
#   # The name that should appear on VirtualBox, edit it to something preferable for you
   vb.name = "eduroam"
...
#   # Never saw the relevance to add in any scripts. Thats all folks
end
